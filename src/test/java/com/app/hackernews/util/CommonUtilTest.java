...
public class CommonUtilTest {
  ...
  public void hackerNewsObjectsToHackerNewsStories() {
    ...
    List<HackerNewsStory> hackerNewsStories = commonUtil.hackerNewsObjectsToHackerNewsStories(hackerNewsObjects);
    HackerNewsStory hackerNewsStory = hackerNewsStories.get(0);
